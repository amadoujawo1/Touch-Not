...
#     if not os.environ.get('REPL_ID') and 'mysql+pymysql' in app.config.get('SQLALCHEMY_DATABASE_URI', ''):
...
#     # Set up database after all extensions and blueprints are registered
#     setup_database(app)
